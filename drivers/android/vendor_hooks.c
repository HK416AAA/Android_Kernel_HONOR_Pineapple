...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_get_trans_qos_by_type);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_get_task_qos);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_should_binder_do_set_priority);
#endif
#ifdef CONFIG_HME_HOOKS_BUILDIN
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_handle_mm_fault);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_folio_mark_accessed);
#endif
#ifdef CONFIG_HONOR_F2FS_DSM
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_dsm);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_dsm_get);
#endif
#ifdef CONFIG_HONOR_UFS_DSM
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufs_dsm);
#endif
