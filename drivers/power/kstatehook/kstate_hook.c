...
kstate_pending_cb kernel_pending_cb_hook;
kstate_binder_cb kernel_binder_cb_hook;
kstate_kill_cb kernel_kill_cb;
kstate_exempt_async_invocation_cb kstate_is_async_call_exempted;


void kstate_pending_cb_hook(kstate_pending_cb kstate_cb_hook)
{
	kernel_pending_cb_hook = kstate_cb_hook;
}
EXPORT_SYMBOL_GPL(kstate_pending_cb_hook);
