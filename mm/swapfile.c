...
EXPORT_SYMBOL_GPL(folio_free_swap);
 ...
 */
int unuse_swap_folio(struct vm_area_struct *vma, unsigned long addr)
{
	struct page *page;
	struct folio *folio;
	swp_entry_t entry;
...
EXPORT_SYMBOL_GPL(unuse_swap_folio);
#endif /* ifdef CONFIG_HME_HOOKS_BUILDIN */
