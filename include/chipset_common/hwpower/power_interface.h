...
enum power_if_sysfs_type {
	...
	POWER_IF_SYSFS_FG_STATE,
	POWER_IF_SYSFS_ESOC,
	POWER_IF_SYSFS_BATT_PARA_CHK,
	POWER_IF_SYSFS_EMERGENCY_MODE,
	POWER_IF_SYSFS_THERMAL_DISABLE,
	POWER_IF_SYSFS_CV_DECREASE_PARA,
	POWER_IF_SYSFS_ENABLE_IBAT_LIMIT,
	POWER_IF_SYSFS_END,
};
...
enum power_if_op_user {
	...
	POWER_IF_OP_USER_AIDL, /* for aidl interface */
...
enum power_if_op_type {
	...
	POWER_IF_OP_TYPE_MAINLVC, /* mainlvc */
	POWER_IF_OP_TYPE_AUXLVC, /* auxlvc */
	POWER_IF_OP_TYPE_SC, /* sc */
	POWER_IF_OP_TYPE_MAINSC, /* mainsc */
	POWER_IF_OP_TYPE_AUXSC, /* auxsc */
	POWER_IF_OP_TYPE_DCPSC, /* dcpsc */
...
struct power_if_ops {
	...
	int (*set_cv_decrease_para)(unsigned int value);
	...
	int (*set_esoc)(int value);
	int (*get_esoc)(int *value);
	...
	int (*get_batt_para_chk)(int *value);
	int (*set_emergency_mode)(unsigned int value);
	int (*set_enable_ibat_limit)(int value);
};
