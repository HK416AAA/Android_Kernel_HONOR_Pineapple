...
# endif
	...
	// task struct OEM DATA USAGE Register-Table:
	// android_oem_data1[0] -> RTG depth usage
	// android_oem_data1[1] -> task yield time calc - ai sched
	// android_oem_data1[2] -> task yield time calc - ai sched
	// android_oem_data1[3] -> task qos info ptr - qos sched gki
	// android_oem_data1[4] -> task cpu power calc - power dubai gki
	// android_oem_data1[5] -> task async binder rt gki
