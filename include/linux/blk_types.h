...
enum req_flag_bits {
	...
	__REQ_SW_VIP,		/* vip for io scheduler */
	__REQ_HW_VIP,		/* vip for io scheduler and device */
#endif
...
#ifdef CONFIG_BLK_CGROUP_IOSMART
#define REQ_SW_VIP (__force blk_opf_t)(1ULL << __REQ_SW_VIP) /* vip for io scheduler */
#define REQ_HW_VIP (__force blk_opf_t)(1ULL << __REQ_HW_VIP) /* vip for io scheduler and device */
#endif
