...
#define DSM_UFS_FFU_UPDATE_ERR          928008028
#define DSM_UFS_DEVICE_RESET_ERR        928008029
#define DSM_UFS_QCOM_BER_ERR            928008030
#include <securec.h>
#endif
...
#if IS_ENABLED(CONFIG_SCSI_UFS_HONOR)
...
#ifdef CONFIG_HONOR_UFS_DSM
#define UFS_MSG_MAX_SIZE        512
#define ufs_dsm_report(hba, no, fmt, a...)\
	do {\
		char msg[UFS_MSG_MAX_SIZE];\
		sprintf_s(msg, UFS_MSG_MAX_SIZE-1, fmt, ## a);\
		trace_android_vh_ufs_dsm(hba, (no), (msg));\
