...
EXPORT_SYMBOL(__init_rwsem);
	/*
	 * rwsem_waiter_type & rwsem_waiter uesd for honor vip sched,
	 * please synchronize your modifications @kernel/sched/walt/walt_cfs.c
	 */
...
queue:
	...
	for (;;) {
		...
		if (jiffies_to_msecs(jiffies - start_temp) > 100) {
			trace_rw_sem_debug(owner_pid, (char *)__func__, CALLER_ADDR0,
