...
#define PUT_SINFO_U64(attr, memb) do {					\
	...
	if ((sinfo->filled & BIT(NL80211_STA_INFO_CH_WIDTH))) {
		if (nla_put_s32(msg, NL80211_STA_INFO_CH_WIDTH, sinfo->channel_width))
			goto nla_put_failure;
	}
	if ((sinfo->filled & BIT(NL80211_STA_INFO_NSS))) {
		if (nla_put_s32(msg, NL80211_STA_INFO_NSS, sinfo->nss))
			goto nla_put_failure;
	}
#endif
